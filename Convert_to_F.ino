...
#include "Adafruit_MAX31855.h"      //////////////////////////////////////////////////////////////////not sure yet
    ...
    #define THERMISTORPIN_3 A2  
    #define THERMISTORPIN_4 A3     
...
//Begin LCD Printing
  ...
  //Temp Probe 1//////////////////////////////cant decide on the lable yet
    ...
    //lcd.print("Tray1 ");
      lcd.setCursor (10, 0);
      lcd.print("P1 ");
      if (analogRead(A0) < 1000)  // If the sensor is connected
       {
        lcd.setCursor (13, 0);
         if (tempDisplay == 0)   // If Celsius is selected
          {
      ...
      if (analogRead(A0) > 1000)  // If the sensor is disconnected
       {
        lcd.setCursor (13, 0);
  ...
  //Temp Probe 2///////////////////////////////////////////////////////
   ...
   //lcd.print("Tray2 ");
      lcd.setCursor (11, 1);
      lcd.print("P2 ");
      if (analogRead(A1) < 1000)  // If he sensor is connected
       {
        lcd.setCursor (14, 1);
         if (tempDisplay == 0)   // If Celsius is selected
          {
      ...
      if (analogRead(A1) > 1000)  // If the sensor is disconnected
       {
        lcd.setCursor (14, 1);
        lcd.print("errr  ");  // This displays an error message
         }
  ...
  //Temp Probe 3 
      ...
      //lcd.print("Tray3 ");
        lcd.setCursor (12, 2);
        lcd.print("P3 ");  
        if (analogRead(A2) < 1000)  // If he sensor is connected
         {
          lcd.setCursor (15, 2);
          if (tempDisplay == 0)   // If Celsius is selected
           {
        ...
        if (analogRead(A2) > 1000)  // If the sensor is disconnected
         {
          lcd.setCursor (15, 2);
          lcd.print("errr ");  // This displays an error message
           } 
      ...
      if (buttonMode == 1)    // Check if the smoke level editor is activated
       {
        ...
        if (blinkState == 0)   // Check to see if the text blink is on/off
         {
          if (smokeLevel == 100)   // Check to see if smokeLevel is 3 characters
           {
            lcd.setCursor (2,3);
            lcd.print(" ");  // Insert three blank characters
             }
          if (smokeLevel < 100)   //  Check to see if smokeLevel is below 100
           {
            lcd.setCursor (1,3);
            lcd.print(" ");  // Insert two blank characters 
             }
          if (smokeLevel < 10)       //  If the smoke level is below ten
           {
            lcd.setCursor (0,3);
            lcd.print(" ");  // Insert one blank character
             }
            }
           }      
  ...
  //Temp Probe 4 
    ...
    //lcd.print("Tray4 ");
        lcd.setCursor (13, 3);
        lcd.print("P4 ");  
        if (analogRead(A3) < 1000)  // If the sensor is connected
         {
          lcd.setCursor (16, 3);
          if (tempDisplay == 0)   // If Celsius is selected
           {
        ...
        if (analogRead(A3) > 1000)  // If the sensor is disconnected
         {
          lcd.setCursor (16, 3);
          lcd.print("errr");  // This displays an error message
           } 
